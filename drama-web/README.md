...
# 运行项目。Compile and Hot-Reload for Development
npm run dev

# 打包。Type-Check, Compile and Minify for Production
npm run build

# 语法检测。Lint with [ESLint](https://eslint.org/)
npm run lint
```
...
- [Pure Admin](https://pure-admin.github.io/pure-admin-doc/)、[zym/vue-pure-admin](https://gitee.com/yiming_chang/vue-pure-admin)
