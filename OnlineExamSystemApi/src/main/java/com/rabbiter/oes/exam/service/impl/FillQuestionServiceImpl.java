...
import com.rabbiter.oes.exam.mapper.FillQuestionMapper;
import com.rabbiter.oes.exam.service.FillQuestionService;
...
public class FillQuestionServiceImpl implements FillQuestionService {
    ...
    @Override
    public List<FillQuestion> findByIdAndType(Long paperId) {
